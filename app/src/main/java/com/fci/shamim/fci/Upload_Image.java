...
import com.fci.shamim.fci.Model.Photos;
...
private Button updateBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photoGalleryRef =rootRef.child("PhotoGallery");
...
/*
    ...
    private void uploadData() {
       final String descriptionTx = descriptionEt.getText().toString();
        ...
        photoId = photoGalleryRef.push().getKey();

        StorageReference ref=storageReference.child("photoGallery").child(photoId);
        ...
        ref.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Photos photo=new Photos(photoId,downloadUri.toString(), descriptionTx);

                        photoGalleryRef.child(photoId).setValue(photo).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
